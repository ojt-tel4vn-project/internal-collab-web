...
const NAV_ITEMS: NavItem[] = [
    { label: "Home", href: "/admin/home", icon: GridIcon },
    { label: "Accounts", href: "/admin/accountmanagement", icon: ClockIcon },
    { label: "Attendance", href: "/admin/attendancemanagement", icon: CalendarIcon },
    { label: "Documents", href: "/admin/documents", icon: DocumentIcon },
    { label: "Leaderboard", href: "/admin/leaderboard", icon: TrophyIcon },
    { label: "Leave Request", href: "/admin/leave-overview", icon: CalendarIcon },
    { label: "Configuration", href: "/admin/configuration", icon: NoteIcon },
];
