...
export default async function ManagerLeaveRequestPage() {
    const {
        summary,
        summaryYear,
        quotaCount,
    ...
    return (
                    ...
                    <div className="flex items-start gap-4">
                        <div>
                            <h1 className="text-3xl font-bold">My Leave Request</h1>
                            <p className="text-sm text-slate-500">Manage your personal time off and view real-time balances.</p>
                        </div>
                    </div>
